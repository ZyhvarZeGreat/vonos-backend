/**
 * Default Vonos Mechanic service engagement terms (HQ6 invoice / packing / delivery print).
 * Overridden when Invoice Settings `termsText` is set for the tenant.
 * Wording matches legacy HQ6 print templates (fine print, inline section labels).
 */
export const VONOS_AUTOMOTIVE_TERMS_TITLE =
  "Terms & Conditions Of Vehicles Services Engagement with Vonos Automotive Engineering Ltd.";

export const VONOS_AUTOMOTIVE_DISCLAIMER =
  "Disclaimer: Vonos Autos will not be held liable for any damages as a result of work done by other technicians or auto dealerships. Job carried out by vonos is warranted for 24hours. Terms and conditions apply on deposit. Kindly confirm workdone before taking your car out of premises. Thanks for your patronage.";

export const VONOS_AUTOMOTIVE_SUPPORT_LINE =
  "For any complaints on our services please call: 07075179952";
...
NO REFUND POLICY
All payments for services and products are final and non-refundable. This applies under all circumstances, except where required by law.
...
Our Customers have the following rights: To personally purchase any parts approved for use on his car. To inspect, confirm or disapprove any parts purchased for use on his car. Entitled within 48 hours of fixing or handover of a car to apply for a replacement or refund or repair for any major faulty parts purchased by the company or work done by it which fail to be of acceptable quality. Should any parts be replaced, the original parts will be available for the Customer to view and examine until the time of vehicle collection. Customers are entitled to a free tire air pressure check and refill. Safety checks are carried out as part of repairs, but ultimate responsibility for safe driving lies with the customer. Customers must test drive, confirm satisfaction and sign exit form upon collection.

SUB-CONTRACTING
VONOS shall be free to sub-contract any of its obligations under these Terms and Conditions provided that any and all sub-contractors are reasonably skilled in the relevant practices.
...
It is agreed by the parties, that any type of dispute between the parties arising on account of this Terms and Conditions to service, repair, refurbish, reconstruct any automobile between the VONOS or its personnel and any of its customer shall be resolved entirely as a civil dispute affairs and not to be clothed with any criminal coloration. All disputes arising from this Terms and Conditions of Engagement shall be settled either by: (a) Inter-personal mediation (b) Arbitration (c) Reference to any Consumer Right Protection Agencies, or (d) Nigeria Court with civil jurisdiction. The Parties further agrees that, it will be deemed a violation of Human rights of any of the party and a breach of contract for any of the party to criminalize or use the Police to suffer a person on any dispute arising out of this Terms and Conditions of Engagement. A violation of this shall attract damages and compensation in favor of the victimized party.

NOTICES
Notices shall be deemed to have been duly given if delivered personally or through a known agent of the parties or when delivered, by courier, post or when sent by e-mail or regularly used Online media.`;
