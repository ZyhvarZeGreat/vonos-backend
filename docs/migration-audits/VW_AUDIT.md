...
**Source database:** `vonomglk_audit`
**Business name (from `business` table):** Vonos Audit Warehouse
**Dump file:** `Vonos warehouse.sql` (lines 21–12,641)
**Generated:** Jun 24, 2026 at 05:13 AM

---

## 1. Table Inventory

**Total tables:** 70 | **Populated:** 32 | **Empty:** 38

### All tables (with row counts)

| Table | Rows | Status |
|---|---:|---|
| `transactions` | 1,379 | populated |
| `transaction_sell_lines_purchase_lines` | 1,180 | populated |
| `transaction_sell_lines` | 1,160 | populated |
| `purchase_lines` | 1,089 | populated |
| `product_locations` | 675 | populated |
| `product_variations` | 664 | populated |
| `products` | 664 | populated |
| `variations` | 664 | populated |
| `variation_location_details` | 659 | populated |
| `activity_log` | 579 | populated |
| `migrations` | 295 | populated |
| `transaction_payments` | 262 | populated |
| `currencies` | 141 | populated |
| `permissions` | 82 | populated |
| `categories` | 10 | populated |
| `notification_templates` | 10 | populated |
| `role_has_permissions` | 7 | populated |
| `barcodes` | 6 | populated |
| `reference_counts` | 4 | populated |
| `model_has_roles` | 3 | populated |
| `users` | 3 | populated |
| `contacts` | 2 | populated |
| `model_has_permissions` | 2 | populated |
| `roles` | 2 | populated |
| `system` | 2 | populated |
| `units` | 2 | populated |
| `brands` | 1 | populated |
...
| `account_transactions` | 0 | empty |
| `account_types` | 0 | empty |
| `accounts` | 0 | empty |
| `bookings` | 0 | empty |
...
**qty_available:** non-zero=493, zero=166, NULL=0
...
- **Transaction date range:** 2024-01-01 → 2026-06-23 (1,379 dated rows sampled)
- **Operational history:** 1,379 transactions — appears to be real operational data
- **Test products:** None detected in product name sample
- **Stock quantities (`variation_location_details`):** 493 non-zero, 166 zero, 0 NULL (74.8% populated with stock)
...
|---|---|---|
| `opening_stock` | Seed Item.quantity via variation_location_details | 1,101 rows; Seed Item.quantity via variation_location_details |
| `sell` | Order/Sale | 278 rows; Order/Sale + LedgerEntry(revenue) + stock decrement |
