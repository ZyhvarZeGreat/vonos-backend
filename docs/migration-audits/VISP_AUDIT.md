# VISP — MySQL Dump Audit

**Source database:** `vonomglk_vsp`
**Business name (from `business` table):** Vonos Institute Spare Parts
**Dump file:** `localhost.sql` (lines 4,633,955–4,726,244)
...
**Total tables:** 94 | **Populated:** 49 | **Empty:** 45

### All tables (with row counts)

| Table | Rows | Status |
|---|---:|---|
| `transaction_sell_lines_purchase_lines` | 23,494 | populated |
| `transaction_sell_lines` | 18,474 | populated |
| `activity_log` | 11,375 | populated |
| `transactions` | 5,350 | populated |
| `contacts` | 4,799 | populated |
| `transaction_payments` | 3,032 | populated |
| `account_transactions` | 3,027 | populated |
| `product_locations` | 2,639 | populated |
| `product_variations` | 2,639 | populated |
| `variations` | 2,639 | populated |
| `products` | 2,540 | populated |
| `variation_location_details` | 2,337 | populated |
| `purchase_lines` | 2,334 | populated |
| `product_racks` | 1,848 | populated |
| `essentials_payroll_group_transactions` | 588 | populated |
| `role_has_permissions` | 379 | populated |
| `migrations` | 356 | populated |
| `model_has_permissions` | 183 | populated |
| `permissions` | 177 | populated |
| `categories` | 160 | populated |
| `currencies` | 141 | populated |
| `model_has_roles` | 130 | populated |
| `users` | 118 | populated |
| `expense_categories` | 36 | populated |
| `accounts` | 31 | populated |
| `brands` | 31 | populated |
| `essentials_payroll_groups` | 31 | populated |
| `system` | 25 | populated |
| `roles` | 12 | populated |
| `reference_counts` | 10 | populated |
| `notification_templates` | 9 | populated |
| `media` | 6 | populated |
| `oauth_clients` | 4 | populated |
| `units` | 3 | populated |
| `user_contact_access` | 3 | populated |
| `account_types` | 2 | populated |
| `cash_registers` | 2 | populated |
| `customer_groups` | 2 | populated |
| `oauth_personal_access_clients` | 2 | populated |
...
| `essentials_to_dos` | 0 | empty |
| `essentials_todo_comments` | 0 | empty |
| `essentials_todos_users` | 0 | empty |
...
**Verdict:** Partial Ultimate POS overlap (69/77 core tables present)

- Core Ultimate POS tables present: **69 / 77**
- Extension/extra tables: **25**
- Missing from base 77: **1**
...
- `essentials_payroll_group_transactions` (588 rows)
- `essentials_payroll_groups` (31 rows)
- `essentials_reminders` (0 rows)
- `essentials_shifts` (0 rows)
- `essentials_to_dos` (0 rows)
- `essentials_todo_comments` (0 rows)
- `essentials_todos_users` (0 rows)
...
**qty_available:** non-zero=1,450, zero=887, NULL=0
...
- **Transaction date range:** 2024-01-01 → 2026-06-12 (5,350 dated rows sampled)
- **Operational history:** 5,350 transactions — appears to be real operational data
- **Test products:** None detected in product name sample
- **Stock quantities (`variation_location_details`):** 1,450 non-zero, 887 zero, 0 NULL (62.0% populated with stock)
...
|---|---|---|
| `sell` | Order/Sale | 3,016 rows; Order/Sale + LedgerEntry(revenue) + stock decrement |
| `opening_stock` | Seed Item.quantity via variation_location_details | 2,334 rows; Seed Item.quantity via variation_location_details |
