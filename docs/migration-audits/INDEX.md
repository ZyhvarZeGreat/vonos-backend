...
> **hq6 module/route mapping (Ultimate POS → Vonos):** [HQ6_ROUTES_AUDIT.md](./HQ6_ROUTES_AUDIT.md), [HQ6_ENDPOINTS_AUDIT.md](./HQ6_ENDPOINTS_AUDIT.md), **[HQ6_INFRASTRUCTURE_SYNC_PLAN.md](./HQ6_INFRASTRUCTURE_SYNC_PLAN.md)** (sidebar → MySQL → ETL → API → UI).
> **Financial data coverage (cross-tenant):** [FINANCIAL_ENDPOINTS_AUDIT.md](./FINANCIAL_ENDPOINTS_AUDIT.md), [FINANCIAL_DATA_COVERAGE.md](./FINANCIAL_DATA_COVERAGE.md), [FINANCIAL_REPORTS_DATA.md](./FINANCIAL_REPORTS_DATA.md) — machine counts: [dryruns/FINANCIAL_MYSQL_COUNTS.json](./dryruns/FINANCIAL_MYSQL_COUNTS.json), [dryruns/FINANCIAL_POSTGRES_COUNTS.json](./dryruns/FINANCIAL_POSTGRES_COUNTS.json). Scripts: `scripts/financial_coverage_mysql.py`, `apps/api/prisma/scripts/sql-financial-audit.ts`. **VA/HQ6 finance spot-check:** [VA_FINANCE_SPOTCHECK.md](./VA_FINANCE_SPOTCHECK.md) — `npm run prisma:va-finance-spotcheck`, `scripts/va_smoke_test.py`.
>
