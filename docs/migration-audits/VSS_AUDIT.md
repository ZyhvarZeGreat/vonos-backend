# VSS — MySQL Dump Audit

**Source database:** `vonomglk_spmarket`
**Business name (from `business` table):** Vonos Institute Spare Parts
**Dump file:** `localhost.sql` (lines 4,589,070–4,605,190)
...
**Total tables:** 94 | **Populated:** 38 | **Empty:** 56

### All tables (with row counts)

| Table | Rows | Status |
|---|---:|---|
| `transactions` | 1,381 | populated |
| `purchase_lines` | 1,219 | populated |
| `product_locations` | 1,205 | populated |
| `product_variations` | 1,205 | populated |
| `variations` | 1,205 | populated |
| `products` | 1,204 | populated |
| `variation_location_details` | 1,186 | populated |
| `transaction_sell_lines_purchase_lines` | 593 | populated |
| `activity_log` | 525 | populated |
| `transaction_sell_lines` | 505 | populated |
| `migrations` | 356 | populated |
| `role_has_permissions` | 346 | populated |
| `model_has_permissions` | 183 | populated |
| `permissions` | 169 | populated |
| `transaction_payments` | 164 | populated |
| `account_transactions` | 163 | populated |
| `categories` | 160 | populated |
| `currencies` | 141 | populated |
| `model_has_roles` | 130 | populated |
| `users` | 118 | populated |
| `contacts` | 86 | populated |
...
| `cash_register_transactions` | 0 | empty |
| `cash_registers` | 0 | empty |
...
| `essentials_attendances` | 0 | empty |
...
| `essentials_payroll_group_transactions` | 0 | empty |
| `essentials_payroll_groups` | 0 | empty |
...
| `media` | 0 | empty |
| `notification_templates` | 0 | empty |
...
- `essentials_payroll_group_transactions` (0 rows)
- `essentials_payroll_groups` (0 rows)
...
**qty_available:** non-zero=1,167, zero=19, NULL=0
...
- **Transaction date range:** 2026-01-01 → 2026-06-18 (1,381 dated rows sampled)
- **Operational history:** 1,381 transactions — appears to be real operational data
- **Test products:** None detected in product name sample
- **Stock quantities (`variation_location_details`):** 1,167 non-zero, 19 zero, 0 NULL (98.4% populated with stock)
...
|---|---|---|
| `opening_stock` | Seed Item.quantity via variation_location_details | 1,219 rows; Seed Item.quantity via variation_location_details |
| `sell` | Order/Sale | 162 rows; Order/Sale + LedgerEntry(revenue) + stock decrement |
